...
=======
    <div>
      <div className="flex justify-center pt-10">
        {/*For desktop */}
        <div
          className={`hidden lg:grid grid-cols-2  w-[70%] p-24 gap-12 rounded-xl ${blok.bg_color ? "bg-[#660708] text-white" : "bg-white text-black"
            }`}
        >
          {blok.field.map((item: any, index: number) => (
            <div
              className={` ${index === 2 ? "-mt-72" : ""} ${!blok.bg_color ? "-mt-[170px]" : ""
                }`}
>>>>>>> Stashed changes
            >
...
=======
              <div
                className={`${item.full_width && "grid grid-cols-2 w-[1000px] gap-12 "
                  }`}
              >
                {item.menu_item.map((el: any) => (
                  <div className="flex justify-between mb-6">
            ...
            <div className="mt-6" key={index}>
              ...
              >
                <div className="flex justify-center items-center">
                  ...
                  <MdOutlineArrowDropDown
                    fontSize={50}
                    className={`${openDropdown && selectedId == item._uid
                        ? "rotate-180"
                        : "rotate-0"
                      }`}
                  />
