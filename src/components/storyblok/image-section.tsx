...
export const ImageSection = ({ blok }: any) => {
  return (
    <div
      {...storyblokEditable}
      className={`container-section flex flex-col justify-center items-center mx-auto mt-10 lg:mt-16  ${blok.bg_color?.color && "p-5 lg:p-14"
        }`}
    ...
    >
      <div className=" flex flex-col justify-center items-center  w-[100%] text-center mb-5 lg:mb-0 ">
        <div
          className={`flex flex-col gap-5 lg:max-w-[50%] justify-center ${blok.text_white && "text-white"
            }`}
        >
        ...
        <div
          className={`w-[100%] mt-4 lg:w-[50%] lg:mt-0 h-[350px] lg:h-[545px] relative mb-4 ${blok.image_right && "order-1"
            }`}
        >
          <Image
